        ...
        <ul class="flex space-x-8 text-sm font-sans">
          <li>
            <NuxtLink :to="localePath('index')">
              <span class="active border-b-2 border-blue-500 pb-1">Home</span>
            </NuxtLink>
          </li>
          <li>
            <NuxtLink :to="localePath('birthday')">
              <span>{{ $t('birthday.title') }}</span>
            </NuxtLink>
          </li>
          <li>
      ...
      >
        ...
        <div class="follow">
          ...
          <div class="social flex space-x-5 mt-4">
            ...
            <a href="https://es-es.facebook.com/ponyexpressmallorca/">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fab"
